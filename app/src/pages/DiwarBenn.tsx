  ...
  return (
    <section>
      <div id="abonnement">
        ...
        <br />
        <p>Rendez-vous sur la <a href="https://openagenda.com/fr/kerlandrier">page OpenAgenda du
          Kerlandrier</a>,
        </p>
        <p>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "end" }}>
          ...
          <a href="https://openagenda.com/agendas/44891982/events.v2.ics?relative%5B0%5D=current&relative%5B1%5D=upcoming" title="Flux iCal" id="icon-link-ical">
            <div id="icon-ical" />
          </a>
          <a href="https://openagenda.com/agendas/44891982/events.v2.rss?relative%5B0%5D=current&relative%5B1%5D=upcoming" title="Flux RSS" id="icon-link-rss">
            <div id="icon-rss" />
          </a>
        </div>
      ...
      <div id="contribution">
        ...
        <ul>
          ...
          <li>...souhaitez <a href="https://openagenda.com/kerlandrier/contribute">ajouter un évènement non
            présent</a> dans la <a href="https://openagenda.com/fr/kerlandrier">liste des événements</a> (nécessite de créer un
            compte OpenAgenda)
          </li>
          <li>...possédez un agenda type Google Agenda que vous pouvez rendre public.</li>
        </ul>
        <br />
        <p> Site web : <a href="https://kerlandrier.cc">kerlandrier.cc</a> - Contact : contact [at] kerlandrier.cc
        </p>
        <br />
