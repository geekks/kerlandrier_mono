...
export const editoQuery = `${OA_BASE_URL}?${new URLSearchParams(DEFAULT_PARAMS).toString()}&timings[gte]=${today.toUTC()}&timings[lte]=${today.plus({ days: 15 }).toUTC()}&${fieldsParam}&sort=timings.asc`;